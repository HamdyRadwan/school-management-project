...
class AddParent extends Component
{
    ...
    public function firstStepSubmit_edit()
    {
        ...
        $this->validate([
            'Email' => 'required|unique:my__parents,Email,'.$id,
            'National_ID_Father' => 'required|unique:my__parents,National_ID_Father,' .$id,
            'Passport_ID_Father' => 'required|unique:my__parents,Passport_ID_Father,' .$id,
        ]);
        $this->updateMode = true;
        $this->currentStep = 2;
